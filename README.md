<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="output/dark.svg?v=8">
    <source media="(prefers-color-scheme: light)" srcset="output/light.svg?v=8">
    <img alt="Naman's Animated Banner" src="output/dark.svg?v=8" width="100%">
  </picture>
</p>
